...
public static class SerializingExtensions {
    ...
    // public static void Put(this NetDataWriter writer, INetSerializable serializable) {
  ...
  public static T Get<T>(this NetDataReader reader) where T : INetSerializable, new() {
    ...
    public static void PutMany(this NetDataWriter writer, IReadOnlyCollection<INetSerializable> serializableCollection) {
